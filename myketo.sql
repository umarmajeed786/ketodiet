...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 03, 2020 at 08:42 PM
...
(71, 'Egg Fusion', 15, 109, 9, 6, 1, 1, 'Egg-Fusion-1590163139.png', 0, 0, 1, '2020-05-26 22:52:50', '3', NULL, NULL),
...
(850, 129, '4\r\n4\r\n55555'),
(851, 129, '4\r\n4'),
(852, 71, 'Preheat oven at 400 degrees.'),
(853, 71, 'Preheat oven at 400 degrees.'),
(854, 71, 'Line each hole of the muffin tray with 1 ½ pieces of ham. Ensure that there are no holes.'),
(855, 71, 'Mix the spinach and red peppers together. Place a small amount in each hole of the muffin tray.'),
(856, 71, 'Place ½ Tbsp of crumbled feta cheese on top of the spinach and peppers.'),
(857, 71, 'Take the 5 eggs and whisk gently, add the salt and pepper.'),
(858, 71, 'Share the mixture evenly across the muffin tray.'),
(859, 71, 'Place in the oven and bake for 16-18 minutes until the eggs feel set.'),
(860, 71, 'Remove each one gently from the muffin tray.'),
(861, 71, 'Garnish with ¼ tsp of pesto sauce and some of the roasted red peppers.');
...
(4, 'test9@test.com', '2020-05-28 02:06:06'),
(6, 'umar.fn1t@gmail.com', '2020-05-28 03:39:41'),
(7, 'umar.leadz@gmail.com', '2020-05-28 03:43:31'),
(11, 'umar1.fnt@gmail.com', '2020-05-28 04:36:37'),
(12, 'mailchimp@umartest.com', '2020-05-29 03:35:39');
...
(86761400, '', '', 'umar.fnt@gmail.com', '$2y$10$I97eFROwlp1jJBloBej6G..Z77rL1IhEYHTPHjuNXTuL6yyJsjTjC', NULL, b'1', '2020-05-27 19:21:36', '', '2', NULL, NULL, '2020-05-27 22:21:36'),
(86761401, '', '', 'umar.test@gmail.com', '$2y$10$FdZoAm/lKyao9m8CMNUjQeOfnP3oKVhLN6BDKvswjDjfadFrW7vly', NULL, b'1', '2020-05-27 20:00:49', '', '2', NULL, NULL, '2020-05-27 23:00:49'),
(86761402, '', '', 'd2011@gmail.com', '$2y$10$mDQJUxs2gpnxWYVLvefNmeGLqVoYMhE5ypx4kBM0mIojI00ASNC2q', NULL, b'1', '2020-05-27 20:16:56', '', '2', NULL, NULL, '2020-05-27 23:16:56'),
(86761403, '', '', 'd4dfg2232011@gmail.com', '$2y$10$XZckeSRz0H1iLT0XHkP2Zu25m00WGCUfuaBgce2lAaRO2M5QId4a.', NULL, b'1', '2020-05-27 20:23:50', '', '2', NULL, NULL, '2020-05-27 23:23:50');
...
CREATE TABLE `user_addon_payments` (
  `user_addon_payment_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `p_id` varchar(100) NOT NULL,
  `given_name` varchar(100) NOT NULL,
  `amount` varchar(10) NOT NULL,
  `amount_type` int(2) NOT NULL,
  `mehtod` varchar(10) NOT NULL,
  `created_date` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `user_addon_payments`
--

INSERT INTO `user_addon_payments` (`user_addon_payment_id`, `user_id`, `p_id`, `given_name`, `amount`, `amount_type`, `mehtod`, `created_date`) VALUES
(3, 86761396, '6YL35875FY835835X', 'John', '19.99', 2, 'pp', '2020-05-30 02:57:41');
...
(2, 86761400, '8N194258SL2166257', '109.00', 12, 'John', 'pp', '2020-05-28 03:21:36'),
(3, 86761401, '6C638568TF9588013', '18.80', 1, 'John', 'pp', '2020-05-28 04:00:50'),
(4, 86761402, '94B373745X2296748', '18.80', 1, 'John', 'pp', '2020-05-28 04:16:56'),
(5, 86761403, '4CV57693YH334754K', '18.80', 1, 'John', 'pp', '2020-05-28 04:23:50');
...
(19, 86761400, '21', '1023', '853', '0.0', 160, 25, 2, 55, 25, 1, b'0', NULL, '2020-05-28 03:21:37'),
(20, 86761401, '29', '912', '760', '0.0', 160, 60, 1, 75, 70, 1, b'0', NULL, '2020-05-28 04:00:51'),
(21, 86761402, '31', '1119', '933', '0.0', 160, 60, 2, 80, 70, 1, b'0', NULL, '2020-05-28 04:16:56'),
(22, 86761403, '31', '1119', '933', '0.0', 160, 60, 2, 80, 70, 1, b'0', NULL, '2020-05-28 04:23:51');
...
ALTER TABLE `user_addon_payments`
  ADD PRIMARY KEY (`user_addon_payment_id`);
...
--
ALTER TABLE `meal_meat_types`
  MODIFY `meal_meat_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=150;

--
-- AUTO_INCREMENT for table `meal_product_types`
--
ALTER TABLE `meal_product_types`
  MODIFY `meal_product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=258;

--
-- AUTO_INCREMENT for table `meal_recipe_steps`
--
ALTER TABLE `meal_recipe_steps`
  MODIFY `meal_recipe_step_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=862;
...
--
ALTER TABLE `subscribers`
  MODIFY `subscriber_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `users`
--
ALTER TABLE `users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86761404;

--
-- AUTO_INCREMENT for table `user_addon_payments`
--
ALTER TABLE `user_addon_payments`
  MODIFY `user_addon_payment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `user_summary`
  MODIFY `user_summary_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
