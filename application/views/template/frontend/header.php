...
<html lang="en">
    ...
    <head>
        ...
        <link rel="apple-touch-icon-precomposed" sizes="76x76" href="<?= base_url('assets/frontend/images/favicon.jpg') ?>" />
        ...
        <link rel="stylesheet" href="<?= base_url('assets/frontend/js/libs/font-awesome/4.7.0/css/font-awesome.min.css') ?>" />
