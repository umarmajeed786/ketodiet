...
<head>
    ...
    <title>Personalized Keto Diet Meal Plans | Keto</title>
    ...
    <script type="text/javascript">
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-WVCZ9C5');</script>


        <script data-cfasync="false" src="<?= base_url('assets') ?>/js/app01.js"></script>

    </head>
    <body>

        <noscript>
            <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WVCZ9C5"
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 recover-plan">
                        <a href="myplan.html" class="btn-primary plan-recovery-btn">Access my plan</a>
                    </div>
                    <div class="col-xs-6 col-lg-4">
                        <img src="<?= base_url('assets') ?>/images/single-color-logo.svg" class="footer-logo" />
                    </div>
        ...
        <script src="<?= base_url('assets') ?>/js/app273a.js" type="text/javascript"></script>
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $('.gender-buttons .btn').click(function () {
                    ...
                    window.location = "<?= base_url()?>/quiz/" + window.gender + "";
                });
                ...
                $("input[type='button']").click(function(){
                    ...
                    if(radioValue == 'Male'){
                        window.location = "<?= base_url()?>/quiz/male";
                    }
                    if(radioValue == 'Female'){
                        window.location = "<?= base_url()?>/quiz/female";
                    }
                });
            });
        </script>
        ...
        <script type="text/javascript">
            ...
            <script src="<?= base_url('assets') ?>/js/rocket-loader.min.js" data-cf-settings="95c3c5c99d82cfdd525634e1-|49" defer=""></script>
            <script defer src="<?= base_url('assets') ?>/js/beacon.min.js" data-cf-beacon='{"rayId":"58d9dd39699be291","version":"2020.3.0","startTime":1588507673186}'></script>
        </body>
