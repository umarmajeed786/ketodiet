<?php
$model_class = '';
if ($addon_payment_type != 2) {
    $model_class = 'show workout';
    echo "<script>$('#personalizedWorkout').modal('hide');</script>";
}
?>
<div class="content-body">
    ...
    if ($addon_payment_type == 2) {
        ...
        <div class="download-buttons center-block">
            <button class="btn btn-lg btn-success "  type="button">Download Workout</button>
        </div>
    </div>
        <?php
    }else{
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="index.html" class="button button-danger">Cancel</a>
            </div>
        </div> 
    </div>
</div>
...
<input type="hidden" name="amount_type" id="amount_type" value="2">
