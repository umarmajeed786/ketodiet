    ...
    <body>
        ...
        <div class="app-admin-wrap">
            ...
            <div class="side-content-wrap">
                <div class="sidebar-left open pull-left" data-perfect-scrollbar="" data-suppress-scroll-x="true">
                    <ul class="navigation-left text-left">
                        ...
                        <li class="nav-item <?= active_menu('users') ?>">
                            <a class="nav-item-hold" href="<?= base_url('users') ?>">
                                <span class="nav-text"><span class="fa fa-user"></span> Users</span>
                            </a>
                            <div class="triangle"></div>
                        </li>
                        <li class="nav-item <?= active_menu('meals') ?>">
                            <a class="nav-item-hold" href="<?= base_url('meals') ?>">
                                <span class="nav-text"><span class="fa fa-building"></span> Meals</span>
                            </a>
                            <div class="triangle"></div>
                        </li>
                        <?php /*
                ...
                <div class="app-footer">
                    <div class="footer-bottom border-top pt-3 d-flex flex-column flex-sm-row align-items-center">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <p class="m-0">&copy; <?= date('Y') ?> <a href='#' target="_blank">Myketo</a>.</p>
