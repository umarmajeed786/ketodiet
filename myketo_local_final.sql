...
--
-- Host: 127.0.0.1
-- Generation Time: May 23, 2020 at 02:00 PM
...
(27, 'Sautéed Beef Pepper with Cheese and Parsley Topping', 22, 383, 21, 33, 1, 2, 'Sautéed-Beef-Pepper-with-Cheese-and-Parsley-Topping-1590006500.png', 0, 0, 1, '2020-05-21 01:28:20', '3', NULL, NULL),
...
(97, 'Bustling beef salad', 25, 705, 34, 58, 7, 1, 'Bustling-beef-salad-1590212628.png', 0, 0, 1, '2020-05-23 10:43:48', '3', NULL, NULL),
(98, '\"Potato\" Keto Salad', 10, 744, 18, 71, 7, 4, '\"Potato\"-Keto-Salad-1590234409.png', 0, 0, 1, '2020-05-23 16:46:49', '3', NULL, NULL),
(99, 'Keto Coleslaw', 5, 392, 26, 54, 14, 4, 'Keto-Coleslaw-1590234671.png', 0, 0, 1, '2020-05-23 16:51:11', '3', NULL, NULL);
...
(70, 27, 'Cut the beef rib-eye steak into thin slices then set aside.'),
(71, 27, 'Preheat a skillet over medium heat then pour olive oil.'),
(72, 27, 'Stir in the chopped onion and sauté until aromatic.'),
(73, 27, 'Next, add sliced beef to the skillet then season with pepper. Cook until done.'),
(74, 27, 'Transfer the sautéed beef to a serving dish then set aside.'),
(75, 27, 'Quickly combine the goat cheese with minced parsley, grated garlic, and thyme then mix until incorporated and smooth.'),
(76, 27, 'Serve the sautéed beef with the cheese mixture and enjoy it immediately.'),
...
(635, 97, 'Mix mustard and mayonnaise together in a large bowl.'),
(636, 97, 'Add the chopped cabbage to the bowl, mix well together.'),
(637, 97, 'Put beef, tomatoes and pickles on a plate and add a large spoon of the cabbage mixture.'),
...
(641, 99, 'Whisk together mayonnaise, mustard, cider vinegar, salt, and pepper in a bowl.'),
(642, 99, 'Add shredded cabbage, ham, and scallions. Toss well.'),
(643, 99, 'Serve chilled.');
...
CREATE TABLE `user_summary` (
  ...
  `user_id` int(11) NOT NULL,
  `BMI` decimal(11,4) NOT NULL,
  `Kcal` decimal(11,4) NOT NULL,
  `bmr` decimal(11,4) NOT NULL,
...
(1, 0, '30.1783', '759.5768', '632.9807', '0.0', 135, 35, 1, 55, 45, 1, b'0', NULL, '2020-05-22 00:55:19'),
(2, 0, '30.1783', '759.5768', '632.9807', '0.0', 135, 35, 1, 55, 45, 1, b'0', NULL, '2020-05-22 00:55:34'),
(3, 0, '30.1783', '759.5768', '632.9807', '0.0', 135, 35, 1, 55, 45, 1, b'0', NULL, '2020-05-22 00:55:54'),
(4, 86761368, '30.1783', '759.5768', '632.9807', '0.0', 135, 35, 1, 55, 45, 1, b'0', NULL, '2020-05-22 01:03:03'),
(5, 0, '30.1783', '759.5768', '632.9807', '0.0', 135, 35, 1, 55, 45, 1, b'0', NULL, '2020-05-22 01:06:21'),
(6, 0, '30.1783', '759.5768', '632.9807', '0.0', 135, 35, 1, 55, 45, 1, b'0', NULL, '2020-05-22 01:06:43'),
(7, 0, '30.1783', '759.5768', '632.9807', '0.0', 135, 35, 1, 55, 45, 1, b'0', NULL, '2020-05-22 01:07:08'),
(8, 0, '30.1783', '759.5768', '632.9807', '0.0', 135, 35, 1, 55, 45, 1, b'0', NULL, '2020-05-22 01:08:45'),
(9, 86761371, '46.8750', '1835.1787', '1334.6754', '0.0', 160, 65, 1, 120, 160, 1, b'0', NULL, '2020-05-22 03:59:39'),
(10, 0, '21.4844', '815.6218', '679.6848', '0.0', 160, 65, 2, 55, 45, 1, b'0', NULL, '2020-05-22 16:14:01'),
(11, 0, '21.4844', '815.6218', '679.6848', '0.0', 160, 65, 2, 55, 45, 1, b'0', NULL, '2020-05-22 16:14:38'),
(12, 86761372, '21.4844', '815.6218', '679.6848', '0.0', 160, 65, 2, 55, 45, 1, b'0', NULL, '2020-05-22 16:15:27'),
(13, 86761391, '21.4844', '1023.4618', '852.8848', '0.0', 160, 25, 2, 55, 45, 1, b'1', '2020-05-22 21:57:29', '2020-05-22 16:34:47'),
(14, 86761392, '22.3130', '2508.0792', '2090.0660', '0.0', 135, 85, 1, 160, 140, 2, b'1', '2020-05-22 21:58:31', '2020-05-22 17:17:35'),
(15, 86761393, '26.2966', '1308.8452', '1090.7043', '0.0', 185, 45, 2, 90, 45, 1, b'1', '2020-05-22 22:19:53', '2020-05-23 01:17:07'),
(16, 86761394, '35.1562', '1594.7874', '1159.8454', '0.0', 160, 25, 1, 90, 80, 1, b'1', '2020-05-22 22:58:23', '2020-05-23 01:57:34'),
(17, 86761396, '26.6667', '1135.1718', '825.5795', '0.0', 150, 13, 1, 60, 50, 1, b'1', '2020-05-23 13:48:13', '2020-05-23 16:44:30');
...
--
ALTER TABLE `meal_details`
  MODIFY `meal_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;

--
-- AUTO_INCREMENT for table `meal_meat_types`
--
ALTER TABLE `meal_meat_types`
  MODIFY `meal_meat_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;

--
-- AUTO_INCREMENT for table `meal_product_types`
--
ALTER TABLE `meal_product_types`
  MODIFY `meal_product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=191;

--
-- AUTO_INCREMENT for table `meal_recipe_steps`
--
ALTER TABLE `meal_recipe_steps`
  MODIFY `meal_recipe_step_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=644;
...
--
ALTER TABLE `users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86761397;
...
--
ALTER TABLE `user_summary`
  MODIFY `user_summary_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
